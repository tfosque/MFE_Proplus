 ...
 */
const formatActionsBySections = (actions) => actions.reduce((result, p) => {
    const checkboxItem = {
...
exports.default = formatActionsBySections;
//# sourceMappingURL=format-actions-by-sections.js.map