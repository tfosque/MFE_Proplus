export declare const validateRegistrationInput: (body: unknown, errorMessage?: string | undefined) => Promise<any>;
...
declare const _default: {
    validateRegistrationInput: (body: unknown, errorMessage?: string | undefined) => Promise<any>;
