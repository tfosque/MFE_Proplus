...
exports.resolveMiddlewares = exports.resolveRouteMiddlewares = void 0;
...
const resolveRouteMiddlewares = (route, strapi) => {
    ...
    if (!(0, fp_1.isArray)(middlewaresConfig)) {
...
const resolveCustomMiddleware = (resolve, strapi) => {
    ...
    try {
        ...
        if (error instanceof Error && 'code' in error && error.code === 'MODULE_NOT_FOUND') {
            modulePath = path_1.default.resolve(strapi.dirs.dist.root, resolve);
        }
        else {
            throw error;
        }
    ...
    try {
        return (0, utils_1.importDefault)(modulePath);
    }
    catch (err) {
