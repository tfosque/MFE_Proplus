...
declare const validateRouteConfig: (routeConfig: Common.RouteInput) => import("yup/lib/object").AssertsShape<{
    ...
    handler: import("yup/lib/Lazy").default<import("yup/lib/string").RequiredStringSchema<string | undefined, Record<string, any>> | import("yup/lib/mixed").MixedSchema<any, Record<string, any>, any> | import("yup/lib/array").RequiredArraySchema<import("yup").AnySchema, import("yup/lib/types").AnyObject, any[] | undefined>, any>;
