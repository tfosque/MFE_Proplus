...
exports.LicenseCheckError = exports.fetchLicense = exports.verifyLicense = exports.readLicense = void 0;
...
const publicKey = fs_1.default.readFileSync((0, path_1.resolve)(__dirname, '../../resources/key.pub'));
...
const readLicense = (directory) => {
    try {
        const path = (0, path_1.join)(directory, 'license.txt');
...
const fetchLicense = async ({ strapi }, key, projectId) => {
    const response = await strapi
        ...
        body: JSON.stringify({ key, projectId, deviceId: (0, machine_id_1.default)() }),
    })
        .catch(throwError);
