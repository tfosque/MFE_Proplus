    ...
    return {
        ...
        add(customField) {
            ...
            for (const cf of customFieldList) {
                if (!(0, fp_1.has)('name', cf) || !(0, fp_1.has)('type', cf)) {
                ...
                if (inputSize) {
                    if (!(0, fp_1.isPlainObject)(inputSize) ||
                        !(0, fp_1.has)('default', inputSize) ||
                        !(0, fp_1.has)('isResizable', inputSize)) {
                ...
                if ((0, fp_1.has)(uid, customFields)) {
...
exports.default = customFieldsRegistry;
